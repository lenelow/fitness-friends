...
class NewActivity extends Component {
  ...
  validateState = () => {
      ...
      if (nameState > 0 && locationState > 0 && dateState > 0 && timeState > 0 && descriptionState > 0) {
          return false
      } else {
          return true
      }
      ...
      <div className="new-activity form">
        ...
        <form>
          ...
          <div className="descriptionAndButton">
            ...
            <br />
            <Link to="/profile/:id">
              <button className="newActivityButton" onClick={this.handleSubmit} disabled={this.validateState}>
                Submit
              </button>
            </Link>
          </div>
